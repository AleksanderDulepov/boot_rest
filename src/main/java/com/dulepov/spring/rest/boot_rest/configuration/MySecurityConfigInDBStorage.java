package com.dulepov.spring.rest.boot_rest.configuration;
...
public class MySecurityConfigInDBStorage {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                //если общий префикс прописан в контроллере @RequestMapping("/api"), то здесь в url "/api/employees"
                //если общий префикс прописан в application.properties server.servlet.context-path=/api, то здесь в url "/employees"
