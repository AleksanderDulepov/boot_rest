package com.dulepov.spring.rest.boot_rest.controller;


import com.dulepov.spring.rest.boot_rest.entity.Employee;
import com.dulepov.spring.rest.boot_rest.exception_handling.NoSuchEmployeeException;
import com.dulepov.spring.rest.boot_rest.service.CommonService;
import com.dulepov.spring.rest.boot_rest.service.EmployeeService;
...
public class MyRESTController {
    ...
    public Employee addNewEmployee(@Valid @RequestBody Employee employee, BindingResult bindingResult) {
        ...
        //в теле не прописываем id, иначе если он будет то произойдет попытка обновить пользователя-принудительно зануляем, чтобы избежать
        employee.setId(0);
